...
async def carbon_api(e):
   ...
   # driver.find_element_by_xpath("//button[contains(text(),'PNG')]").click()
    ...
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Created by [KIM 🤴](https://t.me/warga_pati/)\
        \nGroup [room mutualan](https://t.me/roommutualann/)",
        force_document=True,
...
async def carbon_api(e):
   ...
   # driver.find_element_by_xpath("//button[contains(text(),'PNG')]").click()
    ...
    await e.client.send_file(
        ...
        file,
        caption="created by [KIM 🤴](https://t.me/warga_pati/)\
        \nGroup mutualan [room mutualan](https://t.me/roommutualann/)",
        force_document=True,
        reply_to=e.message.reply_to_msg_id,
    )
...
async def carbon_api(e):
   ...
   # driver.find_element_by_xpath("//button[contains(text(),'PNG')]").click()
    ...
    await e.client.send_file(
        ...
        file,
        caption="Created By [KIM 🤴](https://t.me/warga_pati/)\
        \nGroup 2 [grup 2](https://t.me/crazy_people345/)",
        force_document=True,
        reply_to=e.message.reply_to_msg_id,
    )
...
async def carbon_api(e):
   ...
   # driver.find_element_by_xpath("//button[contains(text(),'PNG')]").click()
    ...
    await e.client.send_file(
        ...
        file,
        caption="Created by [KIM 🤴](https://t.me/warga_pati/),\
        \nGroup 1 [grup mutualan](https://t.me/roommutualann)",
        force_document=True,
        reply_to=e.message.reply_to_msg_id,
    )
...
async def carbon_api(e):
   ...
   # driver.find_element_by_xpath("//button[contains(text(),'PNG')]").click()
    ...
    await e.client.send_file(
        ...
        file,
        caption="Created by [KIM 🤴](https://t.me/warga_pati/),\
        \nGroup random [crazy people](https://t.me/crazy_people345/)",
        force_document=True,
        reply_to=e.message.reply_to_msg_id,
    )
